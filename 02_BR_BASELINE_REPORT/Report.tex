...
\printnoidxglossary[type=symbol,style=listos]
% Table of contents
\newpage
\tableofcontents
\newpage
...
\include{./Chapter/Trajectory_analysis}
\include{./Chapter/Functional_analysis}
%\include{./Chapter/Requirement_analysis}
\include{./Chapter/Budget_breakdown}
\include{./Chapter/Market_analysis}
\include{./Chapter/Risk_analysis}
\include{./Chapter/Sustain}
\include{./Chapter/Design_options}
