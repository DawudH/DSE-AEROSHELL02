...
The thermal protection system of the IRVE vehicles consists of several layers \cite{Litton} which are shown in Figure \ref{fig:tpslayup}.

\begin{figure}[H]
\centering
\includegraphics[width = 0.55\textwidth]{Figure/IRVE4TPS.jpg}
\caption{Example of the tps lay-up for the IRVE-4 re-entry vehicle\cite[p.6]{Litton}.}
\label{fig:tpslayup}
\end{figure}

There has not yet been an actual entry on Mars with an inflatable shield, but \gls{nasa} has demonstrated a well verified and validated concept \ref{Dillman2010} \cite{Dillman2012}. Another non-verified concept is the use of ballutes \cite{Hall2001}. Which can be appplied in case of high mass transportantion. Due to its large size the thermal loads on the structure are small. However, the capsule, located in front of the ballute is exposed to a the free flow and needs additional thermal protection.
