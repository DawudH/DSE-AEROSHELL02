...
\end{itemize}
Table \ref{tab:tpm} shows the Resource Contingency Allowance (RCA) factors that will be used during the various stages of the design process. The lower limits for the RCA's come from NASA \cite{GoddardSpaceFlightCenter2013}. These RCA's will be used to account for the uncertainty of the analysis methods that will be used to evaluate all the concepts.
