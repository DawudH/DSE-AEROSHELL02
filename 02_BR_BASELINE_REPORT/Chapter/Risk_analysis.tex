...
\end{itemize}
Table \ref{tab:tpm} shows the Resource Contingency Allowance (RCA) factors that will be used during the various stages of the design process. Because of the high uncertainty that is involved with a design like this (as can be seen in table \ref{tab:riskmap}) high RCA factors will be used.
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|}
		\hline
		\textbf{Technical Performance Measurement} & \textbf{Conceptual design contingency [\%]} & \textbf{Preliminary design contingency [\%]} \\
		\hline
		Hypersonic deceleration system mass fraction & & \\ \hline
		Aerobraking duration & & \\ \hline
		Control system reliability & & \\ \hline
	\end{tabular}
\end{table}