...
%
%
function [mtoroidbar,mgasbar,mfactor,mtotalbar,mtotal,pmin,mfilmbar,mgasbarrierbar,mcoatingbar,mgoresbar,maxialbar,mradialbar,minflsysbar] = ST_TC_TIAD_massfunction(Cd,qmax,mf,M,T,...
Do,Di,theta,L,N,I,...
...
%--------------------------------------------------------------------------
Cd   = Cd*ones(1,3)                                    ;         %-
qmax = qmax*ones(1,3)                         ;        %Pa

mf = mf*ones(1,3)                                    ; %mf = 1.0 for supersonic 
...
Do              = Do*ones(1,3)         ;
Di              = Di*ones(1,3)                ;
theta           = theta*ones(1,3)*pi./180.        ;
                            ;   %Characteristic length

N               = [N 1 1]                        ;   %Number of toroids:

I               = I*ones(1,3)                     ;   %Number of radial straps
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
...
%------------------------------Materials-----------------------------------
%--------------------------------------------------------------------------
%%selected_material_gore = 'Upilex-25S'; %Gore material
...
%typeoftoroid = 2; % 0 if Fibre ; 1 if Coat; 2 if Film
