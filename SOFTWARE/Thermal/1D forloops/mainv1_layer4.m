...
% Aero input, qsdot
load('heatflux_orbit_iteration_1_1_entry.mat','T','t','qmax_array','A_whetted')
     ...
     L = layup(:,1);
        ...
        disp(['m = ', num2str(sum(layup(:,1).*layup(:,3))*A_whetted), ' [kg]'])
           ...
           if results(1) > Tallow(1)
               ...
               if results(3) > Tallow(3)
                   while results(3) > Tallow(3)  %Nextel(1643 623 473) harnessedsatin(2073 1373 623 473)
