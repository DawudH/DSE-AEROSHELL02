...
In this section the tool is validated against real experimental data. This data has a given applied heat flux and measures temperature throughout the different layers. The tool should show no extreme deviation from the real experimental data. \textcolor{red}{GIVE SOURCE...2 cases, rigid and inflatable}


\subsection{Results per concept}
Since it has not been possible to verify and validate the tool in time due to a bug in the software, another solution is proposed. 
