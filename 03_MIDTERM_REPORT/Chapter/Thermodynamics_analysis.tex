...
\centring
    ...
    \hline
    Material          & Thermal conductivity \$ \backslashfrac\{W\}\{m*K\} \$ & Density \$ \backslashfrac\{kg\}\{m\^3\} \$ & Specific heat \$ \backslashfrac\{J\}\{kg*K\} \$ & emissivity \$ \backslash[ - \backslash] \$ \\ \hline
