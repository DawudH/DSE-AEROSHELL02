...
This section discusses the options for each of the control systems shown in the \acrlong{dot}. This is related to the shapes of each of the concepts also explaining the check-marks and crosses of table \ref{tab:designconcepts}
...
Thrusters are not considered for the trailing and combined configuration. Due to the aft elements of these designs thrusters cannot be considered as the primary control mechanism. Due to the large moments of inertia (due to aft elements) and very high stability of the aft systems (e.g. compare to a parachute) thrusters cannot be considered due their inefficiency. 

\subsubsection{Control surfaces}
Control surfaces have been divided into two forms; body flaps and morphing of the whole structure which are both covered below.
