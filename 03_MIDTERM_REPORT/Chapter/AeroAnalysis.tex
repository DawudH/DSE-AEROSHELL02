...
Aerodynamic drag is used as the method to decelerate the vehicle from over escape velocity to $\gls{sym:M}=5$ before landing. The drag equation is given in Eq. \ref{eq:drag}, while the lift equation is given in Eq. \ref{eq:lift}.
