...
\subsubsection{Trade-off criteria justification}
...
\begin{table}[H]
	\caption{Lift and lift gradient of the different concepts at $\gls{sym:alpha}=20\left[^\circ\right]$}% CAPTION HERE !
