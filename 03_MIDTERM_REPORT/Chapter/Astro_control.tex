...
\subsubsection{Assumptions}
 ...
 \item The atmosphere stops at a height of 400 [km]. At this point the atmosphere is negligibly thin, adding any more atmosphere would not contribute significantly to the results.
 \end{itemize}
...
\begin{equation}
F=\gls{sym:mdot}\gls{sym:Isp}\gls{sym:ge}
\end{equation}
From equation \ref{eq:rcsmassflow} the required propulsive mass can be determined by multiplying $F$ with timespan $t$.
