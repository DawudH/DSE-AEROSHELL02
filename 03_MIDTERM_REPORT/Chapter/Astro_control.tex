...
The results of the trajectory of Figure \ref{sec:astrorestraj}. Note that multiple trajectories are possible and the values in subsequent chapters do not necessarily derive from this particular trajectory. Figure \ref{sec:astrorestraj} features two atmospheric entries which can also be observed in the 
