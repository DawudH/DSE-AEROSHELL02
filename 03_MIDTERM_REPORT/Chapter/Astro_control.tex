...
\begin{figure}[h]
	...
	\caption{Discretisation error in radius $\left(\gls{sym:R}\right)$ after one pass through the atmosphere for initial position $\left[-4143775,10\cdot\gls{con:rm}\right]$ \left[m\right]and initial velocity $\left[0,-7167.9\right]$ $\left[\frac{m}{s}\right]$} 
