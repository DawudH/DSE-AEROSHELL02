...
The acceleration $\left(\gls{sym:acc}\right)$ follows only from the gravitational pull $\left(\gls{sym:g}\right)$, which can be calculated with equation \ref{eq:grav} \cite{Weiland2004}.
