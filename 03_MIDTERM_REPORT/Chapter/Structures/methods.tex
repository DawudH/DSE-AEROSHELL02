...
\begin{equation}
\gls{sym:mbar} = \frac{\gls{sym:m}}{\gls{sym:m}_{factor}}
\label{eq:dimmass}
\end{equation}
where $\gls{sym:m}_{factor}$ is defined by the following equation
\begin{equation}
\gls{sym:m}_{factor} = \frac{\gls{sym:A_iad} \gls{sym:CD} \gls{sym:q}}{\gls{sym:ge}}
\label{eq:mfactor}
\end{equation}
