...
\item Arial density of the material (\gls{sym:df})
\end{itemize}
...
Yielding as a final output the \acrfull{bc} of the model which can be transformed to the total mass of the isotensoid configuration. This is supplied as a single value following the assumption that all isotensoid components have the same material. The final output of the model can thus be given as:
