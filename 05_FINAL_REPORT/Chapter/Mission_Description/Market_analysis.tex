...
Primary prospects for the use of a \gls{cia} are the following:
\begin{itemize}
...
\end{itemize}
A direct function or use is the first item: the \gls{cia} provides aerodynamic deceleration for (safe) transportation of human payload in a cost-effective manner. While the \gls{cia} is designed for entry on Mars, the design can be extrapolated to perform entry or re-entry on a number of sites, for one Earth.

\subsubsection{Technology}
The \gls{cia} will demonstrate predominantly the following technologies:
\begin{itemize}
...
Identification of the primary characteristics, in terms of a \gls{swot} analysis\footnote{URL: \url{http://www.usfca.edu/fac_staff/weihrichh/docs/tows.pdf}. Accessed: 19-06-2015}, of the proposed \gls{cia} yields Table \ref{tab:swot}.
