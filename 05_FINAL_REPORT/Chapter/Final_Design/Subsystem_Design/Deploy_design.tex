...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\caption{Unrolling deployment mechanism}
		\label{fig:rot}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
