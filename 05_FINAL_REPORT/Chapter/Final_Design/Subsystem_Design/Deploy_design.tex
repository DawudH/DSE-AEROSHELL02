...
The canopy is not only infeasible, but in addition not required considering the thermal protection system in this design. A different thermal protection system outer layer may require the use of such a protective shroud, and should thus be considered with care. The outer layers of the inflatable are composed of Silicon Carbide Nicalon. Silicon Carbide materials are currently developed for high load applications. Moreover, their main drawback is a reduction of performance under oxidised conditions\cite{Dutta2001}. As these conditions are not experienced within the mission no drawback can be mentioned for using Nicalon as outer layer.
