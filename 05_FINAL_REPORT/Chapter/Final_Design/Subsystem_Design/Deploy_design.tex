...
It is essential that the diameter of centerbody and crew module is slightly smaller than the maximum 5 [$m$] diameter to account for inflatable stowage. To this end, the centerbody diameter of 4.5 [$m$] rather than 5 [$m$] is imposed by deployment by taking into account a contingency of 10 $\%$.
