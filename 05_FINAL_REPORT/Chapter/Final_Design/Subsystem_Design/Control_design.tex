...
Engine              & Manufacturer          & Quantity & Mass       & Length  & Propellants   & Nominal Thrust & \gls{sym:Isp} \\ \hline
MONARC 445          & MOOG                  & 8        & 1.6[$kg$]  & 0.41[m] & Hydrazine     & 445[N]         & 321.4[s]      \\ \hline
Clean-up Propellant & Japan IHI company ltd & 2        & 15.7[$kg$] & 1.03[m] & NTO/Hydrazine & 1700[N]        & 235[$s$]     \\ \hline
\end{tabular}
\end{table}

Table \ref{tab:controlmassbreakdown} provides an overview
