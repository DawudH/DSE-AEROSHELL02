\paragraph{Aerodynamic shape} \label{sec:AeroDesign}
 ...
 Figures \ref{fig:aeroshape.frontview} through \ref{fig:aeroshape.isoview} show the final \gls{oml} of the aeroshell. The final shape is composed of circular cross sections stacked on top of each other, with an offset in the $z$-direction. The aeroshell is $1.8m$ high and has a maximum offset of $0.9m$.
