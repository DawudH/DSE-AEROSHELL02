\paragraph{Aerodynamic shape} \label{sec:AeroDesign}
 ...
 \begin{figure}[h]
 	...
 	\begin{subfigure}[b]{0.45\textwidth}
 		\includegraphics[width=0.95\textwidth]{./Figure/Aerodynamics/CDCSCLAlpha.pdf}
 		\caption{Force coefficients in the aerodynamic frame versus angle of attack}
 		\label{fig:CLCDCSAlpha}
 	\end{subfigure}
 	\begin{subfigure}[b]{0.45\textwidth}
 		\includegraphics[width=0.95\textwidth]{./Figure/Aerodynamics/CMXCMYCMZAlpha.pdf}
 		\caption{Moment coefficients in the body frame versus angle of attack}
 		\label{fig:CMxCMyCMzAlpha}
 	\end{subfigure}
 	\begin{subfigure}[b]{0.45\textwidth}
 		\includegraphics[width=0.95\textwidth]{./Figure/Aerodynamics/CLCDAlpha.pdf}
 		\caption{Lift to drag ratio versus angle of attack}
 		\label{fig:CLCDAlpha}
 	\end{subfigure}
 	\begin{subfigure}[b]{0.45\textwidth}
 		\includegraphics[width=0.95\textwidth]{./Figure/Aerodynamics/CGoAlpha.pdf}
 		\caption{Required centre of gravity offset versus angle of attack}
 		\label{fig:CGOAlpha}
 	\end{subfigure}
