...
By dividing the required reaction control moment around a certain axis with the length of the thruster moment arm the required thruster control force $\gls{sym:F}_{req}$ can be determined. From the specific impulse of a thruster \gls{sym:Isp} and its propellant mass flow \gls{sym:mdot} follows the amount of thrust it can generate \cite{Allen2012}:
\begin{equation}
