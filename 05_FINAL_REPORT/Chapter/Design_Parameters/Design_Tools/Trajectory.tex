...
The tool is mainly limited by the 1D implementation of the atmospheric properties. This means that no variations of the atmosphere over longitude, latitude or time are considered. The use of a numerical simulation only introduces a small error. The full Verification and Validation are done in Section \ref{sec:VandVtraj}.