...
%On the basis of these external forces, estimation is performed by a truss analysis. 
...
%The significance of the second assumption is illustrated in Appendix \ref{sec:VandVstruc} discussing the verification and validation of the model. Validation is performed on the basis of \gls{fem} results presented by Lindell et al.. A modified 2D method taking into account some of the 3D effects yields acceptable results for initial force estimations with a maximum error of 15.4\%. The full verification and validation results can be found in Appendix \ref{sec:VandVstruc}.


\paragraph{Inflatable mass estimation method}
