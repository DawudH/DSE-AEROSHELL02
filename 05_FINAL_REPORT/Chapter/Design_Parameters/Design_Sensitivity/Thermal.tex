...
\begin{figure}[h]
	...
	\caption{Areal sensitivity for the three selected lay-ups, both for a direct trajectory and a usual trajectory with orbit after aerocapture. Left pot shows areal mass, whereas the right plot shows the total mass.}
